...
class TongueOne extends StatefulWidget {
  const TongueOne({Key? key}) : super(key: key);

  @override
  State<TongueOne> createState() => _TongueOneState();
}

class _TongueOneState extends State<TongueOne> {
        ...
        child: Center(
          child: Column(
            children: [
              ...
              isStarted
                  ? Image.asset(
                      genderGlobal=='M' ? 'assets/smiley.json' : 'assets/',
                    )
                  : SizedBox(
                      width: width * 0.88,
                      child: Column(
