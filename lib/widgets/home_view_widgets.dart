...
import 'package:rehabis/nft/myrehabis.dart';
...
Widget appBar(double width, double height, BuildContext context) {
  return Column(
    children: [
      AppBar(
...
Widget exercises(double width, double height) {
  return SizedBox(
    width: width * 0.88,
...
Widget tile(String title, String desc, String img, Widget page, BuildContext context, double width) {
...
Widget recomendations(double width, BuildContext context) {
  return SizedBox(
      width: width * 0.84,
      child: Column(children: [
        const SizedBox(
